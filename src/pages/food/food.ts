...
import { DataService, TabsService } from '../../service';
...
export class FoodPage extends Tabs implements OnInit {
  geohash: string;
  headTitle: string;
  ...
  constructor(public navCtrl: NavController,
    ...
    this.headTitle = navParams.get('title');
    this.restaurantCategoryId = navParams.get('restaurant_category_id');
    this.offset = 0;
    this.shopList = [];
    this.touchend = false;
